<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/../novius-os/framework/bootstrap.php';
if (!NC::isIpIn()) {
    die('Accès interdit');
}
...
if (!empty($_GET['opcache_reset'])) {
    d('Reset OP Cache', 0, date('H:i:s'));
    opcache_reset();
}
...
<body>
	...
	<div class="tabs">
        ...
        <div class="tab">
            <label><a href="?noviuscloud=opcache&opcache_reset=1" onclick="return confirm('Are you sure to clear OP Cache?')">Reset OP Cache</a></label>
        </div>
